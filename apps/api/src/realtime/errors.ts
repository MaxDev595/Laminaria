import type { RealtimeErrorCode, RealtimeErrorPayload, RealtimeValidationIssue } from "./types.js";

export class RealtimeDomainError extends Error {
  readonly code: RealtimeErrorCode;
  readonly issues?: RealtimeValidationIssue[];

  constructor(code: RealtimeErrorCode, message: string, issues?: RealtimeValidationIssue[]) {
    super(message);
